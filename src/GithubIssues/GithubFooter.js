    ...
    <div className="footer container-lg px-3" role="contentinfo">
      <div className="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
        <ul className="list-style-none d-flex flex-wrap ">
          <li className="mr-3">
            © 2017 <span title="0.26914s from unicorn-2608971677-dw56v">GitHub</span>, Inc.
          </li>
          <li className="mr-3">
          ...
          <li className="mr-3">
            <a href="https://github.com/site/privacy" data-ga-click="Footer, go to privacy, text:privacy">
              Privacy
            </a>
          </li>
          <li className="mr-3">
            <a href="https://github.com/security" data-ga-click="Footer, go to security, text:security">
              Security
            </a>
          </li>
          <li className="mr-3">
        ...
        <a href="https://github.com" aria-label="Homepage" className="footer-octicon" title="GitHub">
        ...
        <ul className="list-style-none d-flex flex-wrap ">
          ...
          <li className="mr-3">
            <a href="https://github.com/blog" data-ga-click="Footer, go to blog, text:blog">
              Blog
            </a>
          </li>
          <li>
